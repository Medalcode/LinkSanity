...
def sample_bookmarks():
    return [
        ...
        Bookmark(title="Google", url="https://google.com", folder="Search"),  # Duplicate
...
class TestBookmarkOrganizer:
    ...
    def test_format_title_cases(self):
        ...
        assert BookmarkOrganizer.format_title(title, style="title_case") == "Hello World"
        assert BookmarkOrganizer.format_title(title, style="sentence_case") == "Hello world"
