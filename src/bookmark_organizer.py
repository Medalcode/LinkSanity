...
class BookmarkOrganizer:
    ...
    def format_title(title: str, style: str = "title_case") -> str:
        ...
        Args:
            ...
            style: Estilo de formateo ('title_case', 'sentence_case', 'lower', 'upper', 'clean')
        ...
        if style == "title_case":
            ...
            title = re.sub(r'\s*[|\-–—]\s*$', '', title)  # Eliminar separadores al final
    ...
    @staticmethod
    def sort_bookmarks(bookmarks: List[Bookmark], by: str = "title", reverse: bool = False) -> List[Bookmark]:
        """
        Ordena bookmarks
        ...
        if by == "title":
            ...
            return sorted(bookmarks, key=lambda b: (b.folder, b.title.lower()), reverse=reverse)
        elif by == "date":
    ...
    @staticmethod
    def filter_bookmarks(bookmarks: List[Bookmark], 
                        keyword: str = None,
                        folder: str = None,
                        domain: str = None) -> List[Bookmark]:
        """
    ...
    @staticmethod
    def apply_formatting(bookmarks: List[Bookmark], title_style: str = "clean") -> List[Bookmark]:
        """
